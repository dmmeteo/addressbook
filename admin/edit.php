...
<body>
	...
	<div style="margin: auto; text-align: center; width: 300px;">
		<form style="text-align: left;" method="post" enctype="multipart/form-data" action="edit.php">
			...
			first name: <input style="float: right;" type="text" name="first_name" value="<?php echo $userById->first_name; ?>">

			<br><br>
			<span style="color: red;">*</span>
			last name: <input style="float: right;" type="text" name="last_name" value="<?php echo $userById->last_name; ?>">

			<br><br><span style="color: red;">*</span>
			email: <input style="float: right;" type="text" name="email" value="<?php echo $userById->email; ?>">

			<br><br><span style="color: red;">*</span>
			country: <input style="float: right;" type="text" name="country" value="<?php echo $userById->country; ?>">

			<br><br><span style="color: red;">*</span> 
			city: <input style="float: right;" type="text" name="city" value="<?php echo $userById->city; ?>">
			...
			<br><br><br>notes: <br><textarea rows="8" cols="40" name="note"><?php echo $userById->note; ?></textarea>
			<br><br>
